...
export default function StaffManagementModal({ isOpen, onClose, onStaffUpdated }) {
  ...
  return (
    <div className="modal-overlay staff-modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal modal-wide staff-modal-container" role="dialog" aria-modal="true">
        <div className="modal-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: 0 }}>จัดการพนักงาน & สิทธิ์ (Staff)</h3>
        ...
        {showAddForm ? (
          <form onSubmit={handleSubmit} className="staff-form">
            <h4 style={{ fontSize: 15, marginBottom: 14, color: 'var(--text-main)' }}>
